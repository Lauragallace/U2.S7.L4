  ...
  col.innerHTML = `
            <div class="card mb-4 shadow-sm">
              <img
                ...
                alt="${photo.alt}"
                onclick=location.href="./dettaglio.html?id=${photo.id}" 
              />
              <div class="card-body">
                <h5 class="card-title" onclick=location.href="./dettaglio.html?id=${photo.id}">${photo.alt}</h5>
                <p class="card-text">
...
if (query != null) {
  back.setAttribute("href", `pexel.html?query=${query}`);
}
